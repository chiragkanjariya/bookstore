        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('home') }}"
                        class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-[#00BDE0]">
                                            ...
                                            <div class="flex items-start justify-between">
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex items-center space-x-2 mt-2">
                                                        <span
                                                            class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-[#00BDE0] text-white">
                                                ...
                                                <div class="flex items-center space-x-4">
                                                    ...
                                                    <div class="flex items-center border border-gray-300 rounded-lg">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            value="{{ $item->quantity }}" min="1" max="99999"
                    ...
                    <div class="bg-white shadow-sm rounded-lg p-6">
                            ...
                            <div class="border-t border-gray-200 pt-4">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-lg font-semibold text-gray-900"
                                        id="total">₹{{ number_format($subtotal, 2) }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 space-y-3">
                            <a href="{{ route('checkout.index') }}"
                                class="w-full bg-[#00BDE0] text-white py-3 px-4 rounded-lg hover:bg-[#00A5C7] transition-colors font-medium text-lg text-center block">
                                Proceed to Checkout
                            </a>
                            <a href="{{ route('home') }}"
                                class="w-full bg-gray-200 text-gray-900 py-3 px-4 rounded-lg hover:bg-gray-300 transition-colors font-medium text-center block">
                                Continue Shopping
                            </a>
                        </div>
                    </div>
                ...
                fetch(`/cart/${itemId}`, {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            // Update total
                            document.getElementById('total').textContent = `₹${parseFloat(data.subtotal).toFixed(2)}`;
