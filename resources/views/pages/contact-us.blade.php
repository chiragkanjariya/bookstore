                ...
                <div class="space-y-8">
                    <div class="text-center bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-8 border border-blue-100">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <a href="tel:+916356130234" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200">
