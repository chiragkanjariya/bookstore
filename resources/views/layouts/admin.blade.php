        ...
        <div class="flex flex-col h-full">
            ...
            <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <span class="text-lg font-bold text-gray-900">BookStore</span>
                        <div class="text-xs text-[#00BDE0] font-medium">Admin Panel</div>
                    </div>
                </div>
                <!-- Mobile Close Button -->
                ...
                <div class="mb-6">
                    ...
                    <a href="{{ route('admin.books.index') }}" 
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.books.*') ? 'bg-[#00BDE0] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                        ...
                        Books
                        <span class="ml-auto bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-full">{{ \App\Models\Book::count() }}</span>
                    </a>
                    ...
                    <a href="{{ route('admin.categories.index') }}" 
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.categories.*') ? 'bg-[#00BDE0] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                        ...
                        Categories
                        <span class="ml-auto bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-full">{{ \App\Models\Category::count() }}</span>
                    </a>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <a href="{{ route('admin.users.index') }}" 
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.users.*') ? 'bg-[#00BDE0] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                        ...
                        Manage Users
                        <span class="ml-auto bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-full">{{ \App\Models\User::count() }}</span>
                    </a>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <a href="{{ route('admin.orders.index') }}" 
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.orders.*') ? 'bg-[#00BDE0] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                        ...
                        Orders
                        <span class="ml-auto bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-full">{{ \App\Models\Order::count() }}</span>
                    </a>
                </div>
            ...
            <div class="border-t border-gray-200 p-4">
                ...
                <div class="mt-3 flex space-x-2">
                    <a href="/" class="flex-1 text-center bg-gray-100 text-gray-700 px-3 py-2 rounded-lg text-sm hover:bg-gray-200 transition-colors">
                        View Site
                    </a>
                    <form method="POST" action="{{ route('logout') }}" class="flex-1">
                        @csrf
                        <button type="submit" class="w-full bg-red-100 text-red-700 px-3 py-2 rounded-lg text-sm hover:bg-red-200 transition-colors">
                            Logout
                        </button>
                    </form>
                </div>
            ...
            <div class="flex items-center justify-between px-4 sm:px-6 py-4">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="relative" id="add-dropdown">
                        <button id="add-button" class="bg-[#00BDE0] text-white px-4 py-2 rounded-lg hover:bg-[#00A5C7] transition-colors font-medium flex items-center space-x-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Dropdown Menu -->
                        <div id="add-menu" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 hidden">
                            <a href="{{ route('admin.books.create') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                Add New Book
                            </a>
