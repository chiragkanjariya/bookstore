                    ...
                    <div class="mb-6">
                        ...
                        @foreach($group['items'] as $item)
                            <a href="{{ route($item['route']) }}"
                                class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs($item['pattern']) ? 'bg-[#00BDE0] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-t border-gray-200 p-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-gray-500 truncate">{{ Auth::user()->getAdminRoleName() }}</p>
                    </div>
                </div>
