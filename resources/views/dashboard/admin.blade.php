                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                {{ number_format($stats['integrated_courrier']) }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
                    @foreach($regionalSales as $region)
                        <div
                            ...
                            <div
                                class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-gradient-to-br from-[#00BDE0]/10 to-transparent rounded-full z-0">
                            </div>
                            ...
                            <div class="relative z-10 grid grid-cols-1 gap-3">
                                <div class="bg-green-50 p-3 rounded-md border border-green-100">
                                    ...
                                    <p class="text-lg font-extrabold text-green-900">{{ number_format($region['paid_count']) }}
                                    </p>
                                </div>
                            </div>
                        </div>
