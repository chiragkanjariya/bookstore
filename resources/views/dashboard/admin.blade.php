                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div class="h-10 w-10 bg-[#00BDE0] rounded-full flex items-center justify-center">
                                                    <span class="text-sm font-medium text-white">{{ substr($recentUser->name, 0, 1) }}</span>
                                                </div>
                                            </div>
                                            <div class="ml-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ $recentUser->isAdmin() ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }}">
                                            {{ $recentUser->getRoleName() }}
                                        </span>
                                    </td>
        ...
        <div class="bg-white shadow rounded-lg mt-8">
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('admin.orders.index') }}" class="text-sm text-blue-600 hover:text-blue-800">View all orders</a>
                </div>
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Orders will appear here as customers make purchases.</p>
                    </div>
                @endif
            </div>
        </div>
