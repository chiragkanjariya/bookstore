        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Update {{ $category->name }} details</p>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                <span class="text-gray-500">Active Books:</span>
                                <span class="font-medium text-gray-900">{{ $category->active_books_count }}</span>
                            </div>
                            <div>
                                <span class="text-gray-500">Created:</span>
                                <span class="font-medium text-gray-900">{{ $category->created_at->ist()->format('M d, Y') }}</span>
                            </div>
                            <div>
                                <span class="text-gray-500">Last Updated:</span>
                                <span class="font-medium text-gray-900">{{ $category->updated_at->ist()->format('M d, Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
