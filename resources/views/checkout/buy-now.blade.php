...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function recalculateShipping(stateId) {
        const bookId = document.querySelector('input[name="buy_now_book_id"]').value;
        const quantity = document.querySelector('input[name="buy_now_quantity"]').value;
