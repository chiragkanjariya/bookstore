            ...
            <div id="loginForm" class="auth-form">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="{{ route('password.request') }}"
                                    class="font-medium text-[#00BDE0] hover:text-[#00A5C7]">Forgot password?</a>
                            </div>
                        </div>
                ...
                <div class="mt-4 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <button id="showRegisterForm" class="font-medium text-[#00BDE0] hover:text-[#00A5C7]">Sign
                            up</button>
                    </p>
                </div>
            </div>
            ...
            <div id="registerForm" class="auth-form hidden">
                <form id="registerFormElement" method="POST">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="register_phone" class="block text-sm font-medium text-gray-700">Phone Number
                ...
                <div class="mt-4 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <button id="showLoginForm" class="font-medium text-[#00BDE0] hover:text-[#00A5C7]">Sign
                            in</button>
                    </p>
                </div>
            </div>
